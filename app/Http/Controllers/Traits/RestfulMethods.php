...
use App\Helpers\TransformerManager;
...
trait RestfulMethods
{
    ...
    public function index()
    {
        ...
        return TransformerManager::collection($data, $this->_transformer);
    }
    ...
    {
        $data = TransformerManager::prepare($request->all(), $this->_transformer);
        ...
        if (!$validator->fails()) {
            ...
            $vo->fill($data);
            $vo->save();
            return TransformerManager::item($vo, $this->_transformer);
        }
    ...
    {
        return TransformerManager::item($this->_model->find($id), $this->_transformer);
    }
