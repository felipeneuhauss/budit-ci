...
class CustomModel extends Command
{
     ...
     * @var string
     */
    protected $signature = 'custom:model {tableName?}';
    ...
    private $interfaceModelName = 'InterfaceModel';
...
//
//        if ($this->confirm('A model irá implementar alguma interface?', true)) {
//            $this->interfaceModelName = $this->ask('Qual o nome da interface?', $this->interfaceModelName);
//        } else {
//            $this->interfaceModelName = "";
//        }
